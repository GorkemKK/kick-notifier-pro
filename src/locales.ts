...
export const translations = {
    en: {
        ...
        notifStyle: 'Notification Style',
        notifStyleDesc: 'How should the notification appear?',
        styleTransient: 'Auto Close (Top)',
        stylePersistent: 'Stay Until Clicked (Desktop)',
        sound: 'Sound Effects',
    ...
    tr: {
        ...
        notifStyle: 'Bildirim Tarzı',
        notifStyleDesc: 'Bildirim nasıl görünsün?',
        styleTransient: 'Otomatik Kaybolan (Üstte)',
        stylePersistent: 'Tıklayana Kadar Kalıcı (Masaüstünde)',
        sound: 'Ses Efekti',
